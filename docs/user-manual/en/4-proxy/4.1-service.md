...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (Switchy)
...
After starting the proxy and enabling app takeover, Switchy modifies app configurations:
...
When stopping the proxy, Switchy will:
