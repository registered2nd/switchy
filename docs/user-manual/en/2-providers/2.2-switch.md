...
2. Switchy updates the configuration file
...
1. Right-click the Switchy icon in the system tray
...
When switching providers, Switchy modifies the following files:
