...
Switchy provides rich icon customization features:
...
This ensures Switchy and CLI tool configurations stay in sync.
...
When adding a provider, Switchy automatically extracts endpoint URLs from the configuration.
