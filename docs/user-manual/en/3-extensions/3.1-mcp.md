...
When enabling an app's toggle, Switchy will:
...
When disabling an app's toggle, Switchy will:
...
If you have already configured MCP servers in CLI tools, you can import them into Switchy:

1. Click the "Import" button
2. Select the app to import from (Claude/Codex/Gemini/OpenCode)
3. Switchy reads the existing configuration and imports it
