...
**[中文更新说明 Chinese Documentation →](https://github.com/registered2nd/switchy/blob/main/docs/release-notes/v3.6.0-zh.md)**
...
- Download `Switchy-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `Switchy-v3.6.0-Windows.msi`
- **Portable**: `Switchy-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**: `Switchy-v3.6.0-Linux.AppImage`
- **Debian**: `Switchy-v3.6.0-Linux.deb`
...
**Full Changelog**: https://github.com/registered2nd/switchy/compare/v3.5.1...v3.6.0
