...
- **ArchLinux Installation Support** (#259)
  Added AUR installation method: `paru -S switchy-bin`
...
Visit [Releases](https://github.com/registered2nd/switchy/releases/latest) to download the latest version
...
- **Deep link integration** - Import via `switchy://` protocol
...
v3.7.0 represents a shift in Switchy's positioning:
...
Visit [Releases](https://github.com/registered2nd/switchy/releases/latest) to download:

- **Windows**: `Switchy-Windows.msi` or `-Portable.zip`
- **macOS**: `Switchy-macOS.tar.gz` or `.zip`
- **Linux**: `Switchy-Linux.AppImage` or `.deb`
- **ArchLinux**: `paru -S switchy-bin`
...
[Register with "switchy" code for 10% discount](https://www.packyapi.com/register?aff=switchy)
...
- **Issues**: [GitHub Issues](https://github.com/registered2nd/switchy/issues)
- **Discussions**: [GitHub Discussions](https://github.com/registered2nd/switchy/discussions)
