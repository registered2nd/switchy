...
Switchy v3.8.0 はデータ永続化レイヤーと UI を大幅に作り替え、今後のクラウド同期やローカルプロキシ機能に向けた基盤を整えたメジャーアップデートです。
...
[Releases](https://github.com/registered2nd/switchy/releases/latest) から入手:

- **Windows**: `Switchy-v3.8.0-Windows.msi` または `-Portable.zip`
- **macOS**: `Switchy-v3.8.0-macOS.tar.gz` または `.zip`
- **Linux**: `Switchy-v3.8.0-Linux.AppImage` または `.deb`
...
[登録時に「switchy」で 10% オフ](https://www.packyapi.com/register?aff=switchy)
...
- **Issue**: [GitHub Issues](https://github.com/registered2nd/switchy/issues)
