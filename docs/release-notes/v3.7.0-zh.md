...
Switchy v3.7.0 新增六大核心功能，新增超过 18,000 行代码。
...
- **Windows**：`Switchy-v3.7.0-Windows.msi` 或 `-Portable.zip`
- **macOS**：`Switchy-v3.7.0-macOS.tar.gz` 或 `.zip`
- **Linux**：`Switchy-v3.7.0-Linux.AppImage` 或 `.deb`
...
[使用 "switchy" 代码注册可享受 10% 折扣](https://www.packyapi.com/register?aff=switchy)
