...
- **ArchLinux 安装支持** (#259)
  添加 AUR 安装方式：`paru -S switchy-bin`
...
访问 [Releases](https://github.com/registered2nd/switchy/releases/latest) 下载最新版本
...
访问 [Releases](https://github.com/registered2nd/switchy/releases/latest) 下载：

- **Windows**：`Switchy-Windows.msi` 或 `-Portable.zip`
- **macOS**：`Switchy-macOS.tar.gz` 或 `.zip`
- **Linux**：`Switchy-Linux.AppImage` 或 `.deb`
...
[使用 "switchy" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=switchy)
...
- **问题反馈**：[GitHub Issues](https://github.com/registered2nd/switchy/issues)
- **讨论**：[GitHub Discussions](https://github.com/registered2nd/switchy/discussions)
