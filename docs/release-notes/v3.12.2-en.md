...
| File                                       | Description                                          |
| ------------------------------------------ | ---------------------------------------------------- |
| `Switchy-v3.12.2-Windows.msi`            | **Recommended** - MSI installer with auto-update     |
| `Switchy-v3.12.2-Windows-Portable.zip`   | Portable version, extract and run, no registry write |

### macOS

| File                               | Description                                                          |
| ---------------------------------- | -------------------------------------------------------------------- |
| `Switchy-v3.12.2-macOS.zip`      | **Recommended** - Extract and drag to Applications, Universal Binary |
| `Switchy-v3.12.2-macOS.tar.gz`   | For Homebrew installation and auto-update                            |
