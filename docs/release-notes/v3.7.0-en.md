...
Switchy v3.7.0 introduces six major features with over 18,000 lines of new code.
...
- **Windows**: `Switchy-v3.7.0-Windows.msi` or `-Portable.zip`
- **macOS**: `Switchy-v3.7.0-macOS.tar.gz` or `.zip`
- **Linux**: `Switchy-v3.7.0-Linux.AppImage` or `.deb`
