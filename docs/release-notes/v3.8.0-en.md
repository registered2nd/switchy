...
Switchy v3.8.0 is a major architectural upgrade that restructures the data persistence layer and user interface, laying the foundation for future cloud sync and local proxy features.
...
- **Windows**: `Switchy-v3.8.0-Windows.msi` or `-Portable.zip`
- **macOS**: `Switchy-v3.8.0-macOS.tar.gz` or `.zip`
- **Linux**: `Switchy-v3.8.0-Linux.AppImage` or `.deb`
...
[Use code "switchy" for 10% off registration](https://www.packyapi.com/register?aff=switchy)
...
- **Issue Reports**: [GitHub Issues](https://github.com/registered2nd/switchy/issues)
