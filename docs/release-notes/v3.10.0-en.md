...
Switchy v3.10.0 introduces OpenCode support, becoming the fourth managed CLI application.
...
| File                                     | Description                                          |
| ---------------------------------------- | ---------------------------------------------------- |
| `Switchy-v3.10.0-Windows.msi`          | **Recommended** - MSI installer with auto-update     |
| `Switchy-v3.10.0-Windows-Portable.zip` | Portable version, extract and run, no registry write |

### macOS

| File                             | Description                                                        |
| -------------------------------- | ------------------------------------------------------------------ |
| `Switchy-v3.10.0-macOS.zip`    | **Recommended** - Extract and drag to Applications, Universal Binary |
| `Switchy-v3.10.0-macOS.tar.gz` | For Homebrew installation and auto-update                          |
