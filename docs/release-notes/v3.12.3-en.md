...
Added full reverse proxy support for GitHub Copilot, enabling Copilot-authenticated requests to be forwarded through Switchy.
...
- Backups stored in `~/.switchy/skill-backups/` with all skill files and a `meta.json` containing original metadata
...
Users enable this feature **at their own risk**. Switchy is not responsible for any account restrictions, warnings, or service suspensions resulting from the use of this feature.

---

## Download & Installation

Visit [Releases](https://github.com/registered2nd/switchy/releases/latest) to download the appropriate version.
...
| File                                       | Description                                          |
| ------------------------------------------ | ---------------------------------------------------- |
| `Switchy-v3.12.3-Windows.msi`            | **Recommended** - MSI installer with auto-update     |
| `Switchy-v3.12.3-Windows-Portable.zip`   | Portable version, extract and run, no registry write |

### macOS

| File                               | Description                                                          |
| ---------------------------------- | -------------------------------------------------------------------- |
| `Switchy-v3.12.3-macOS.dmg`     | **Recommended** - DMG installer, drag to Applications, Universal Binary |
| `Switchy-v3.12.3-macOS.zip`     | ZIP archive, extract and drag to Applications, Universal Binary      |
| `Switchy-v3.12.3-macOS.tar.gz`  | For Homebrew installation and auto-update                            |
...
| --------------------------------------- | ------------------ | ---------------------------------------------------------------------- |
| Ubuntu / Debian / Linux Mint / Pop!\_OS | `.deb`             | `sudo dpkg -i Switchy-*.deb` or `sudo apt install ./Switchy-*.deb` |
| Fedora / RHEL / CentOS / Rocky Linux    | `.rpm`             | `sudo rpm -i Switchy-*.rpm` or `sudo dnf install ./Switchy-*.rpm`  |
| openSUSE                                | `.rpm`             | `sudo zypper install ./Switchy-*.rpm`                                |
| Arch Linux / Manjaro                    | `.AppImage`        | Add execute permission and run directly, or use AUR                    |
| Other distributions / Unsure            | `.AppImage`        | `chmod +x Switchy-*.AppImage && ./Switchy-*.AppImage`              |