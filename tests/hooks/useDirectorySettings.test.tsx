...
const getDefaultCodexMirrorDirMock = vi.hoisted(() => vi.fn());
...
vi.mock("@/lib/api", () => ({
  settingsApi: {
    ...
    getDefaultCodexMirrorDir: getDefaultCodexMirrorDirMock,
  },
}));
...
describe("useDirectorySettings", () => {
  ...
  beforeEach(() => {
    ...
    getDefaultCodexMirrorDirMock.mockResolvedValue(null);
  ...
  it("resets directories to computed defaults", async () => {
    ...
    expect(result.current.resolvedDirs.appConfig).toBe("/home/mock/.switchy");
  });
