//! Deep link import functionality for Switchy
//!
//! This module implements the switchy:// protocol for importing configurations
...
///
/// Represents a parsed switchy:// URL ready for processing.
