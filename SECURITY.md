...
Only the latest release of Switchy receives security updates.

仅最新版本的 Switchy 会收到安全更新。
...
Instead, please report them through [GitHub Security Advisories](https://github.com/registered2nd/switchy/security/advisories/new).

请通过 [GitHub 安全公告](https://github.com/registered2nd/switchy/security/advisories/new) 进行报告。
...
Security fixes are released as patch versions and announced via [GitHub Releases](https://github.com/registered2nd/switchy/releases). We recommend always updating to the latest version.

安全修复通过补丁版本发布，并通过 [GitHub Releases](https://github.com/registered2nd/switchy/releases) 通知。建议始终更新到最新版本。
